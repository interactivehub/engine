...
type JoinWheelRoundRequest struct {
	...
	Bet    float32   `protobuf:"fixed32,2,opt,name=bet,proto3" json:"bet,omitempty"`
...
func (x *JoinWheelRoundRequest) GetBet() float32 {
	if x != nil {
		return x.Bet
	}
	return 0
...
var file_postman_games_wheel_wheel_service_proto_rawDesc = []byte{
	...
	0x20, 0x01, 0x28, 0x02, 0x52, 0x03, 0x62, 0x65, 0x74, 0x12, 0x2c, 0x0a, 0x04, 0x70, 0x69, 0x63,
